    ...
    function checkDOMListeners(delta) {
      ...
      if (listenerCount === 1 && delta === 1) {
        ...
        if (needsHashChangeListener)
          window.addEventListener(HashChangeEvent$2, handleHashChange);
      } else if (listenerCount === 0) {
        window.removeEventListener(PopStateEvent$1, handlePopState);
        if (needsHashChangeListener)
          window.removeEventListener(HashChangeEvent$2, handleHashChange);
      }
    }
      ...
      _proto.render = function render() {
        ...
        return React.createElement(
          ...
          function (context$$1) {
            ...
            var location =
              typeof to === "string"
                ? createLocation$1(to, null, null, context$$1.location)
                : to;
