!(function (e, r) {
  "object" == typeof exports && "undefined" != typeof module
    ? r(exports, require("mobx"), require("react"), require("mobx-react-lite"))
    : "function" == typeof define && define.amd
    ? define(["exports", "mobx", "react", "mobx-react-lite"], r)
    : r(((e = e || self).mobxReact = {}), e.mobx, e.React, e.mobxReactLite);
  ...
  function j(e) {
    ...
    return (
      ...
      m(r, "componentWillUnmount", function () {
        var e;
        if (
          !0 !== n.isUsingStaticRendering() &&
          (null == (e = this.render[v]) || e.dispose(),
          (this[O] = !0),
          !this.render[v])
        ) {
          var r = P(this);
  ...
  function x(e) {
    var o = this;
    if (!0 === n.isUsingStaticRendering()) return e.call(this);
    l(this, g, !1), l(this, w, !1);
    var a = P(this),
      i = e.bind(this),
      c = !1,
      s = new r.Reaction(a + ".render()", function () {
        if (!c && ((c = !0), !0 !== o[O])) {
          var e = !0;
          try {
            l(o, w, !0),
              o[g] || t.Component.prototype.forceUpdate.call(o),
              (e = !1);
          } finally {
            l(o, w, !1), e && s.dispose();
          }
    ...
    return (
      (s.reactComponent = this), (u[v] = s), (this.render = u), u.call(this)
    );
  }
  function R(e, r) {
    return (
      n.isUsingStaticRendering() &&
        console.warn(
          "[mobx-react] It seems that a re-rendering of a React component is triggered while in static (server-side) mode. Please make sure components are rendered only once server-side."
        ),
      this.state !== r || !s(this.props, e)
    );
  }
  function S(e, t) {
    var n = c("reactProp_" + t + "_valueHolder"),
      o = c("reactProp_" + t + "_atomHolder");
    function a() {
      ...
      get: function () {
        ...
        return (
          r._allowStateReadsStart &&
            ...
            (e = r._allowStateReadsStart(!0)),
          a.call(this).reportObserved(),
          r._allowStateReadsStart &&
            r._allowStateReadsEnd &&
            r._allowStateReadsEnd(e),
          this[n]
        );
      },
      set: function (e) {
  ...
  function k(e) {
    ...
    if (E && e.$$typeof === E) {
      ...
      return t.forwardRef(function () {
        var e = arguments;
        return t.createElement(n.Observer, null, function () {
  ...
  function M(e) {
    var r = e.children,
      ...
      n = o.useContext(_),
      a = o.useRef(U({}, n, t));
    return o.createElement(_.Provider, { value: a.current }, r);
  }
  function T(e, r, t, n) {
    var a,
      i,
  ...
  var q = c("disposeOnUnmountProto"),
    D = c("disposeOnUnmountInst");
  function L() {
    var e = this;
  ...
  function N(e) {
    function t(t, n, o, a, i, c) {
      for (
        var s = arguments.length, u = new Array(s > 6 ? s - 6 : 0), f = 6;
        f < s;
        f++
      )
        u[f - 6] = arguments[f];
            ...
            ? t
              ? new Error(
                  "The " +
                    ...
                    a +
                    "`, but its value is `" +
                    (null === n[o] ? "null" : "undefined") +
                    "`."
                )
              : null
            : e.apply(void 0, [n, o, a, i, c].concat(u))
        );
      });
    }
    var n = t.bind(null, !1);
  ...
  function F(e, t) {
    return N(function (n, o, a, i, c) {
      for (
        var s = arguments.length, u = new Array(s > 5 ? s - 5 : 0), f = 5;
        f < s;
        f++
      )
        u[f - 5] = arguments[f];
      return r.untracked(function () {
        ...
        var r = X(e, "Array")(n, o, a, i, c);
        if (r instanceof Error) return r;
        for (var s = n[o], f = 0; f < s.length; f++)
          if (
            (r = t.apply(
              void 0,
              [s, f, a, i, c + "[" + f + "]"].concat(u)
            )) instanceof Error
          )
            return r;
        return null;
  ...
  var W = {
    observableArray: X(!1, "Array"),
    observableArrayOf: F.bind(null, !1),
    observableMap: X(!1, "Map"),
    observableObject: X(!1, "Object"),
    arrayOrObservableArray: X(!0, "Array"),
    arrayOrObservableArrayOf: F.bind(null, !0),
    objectOrObservableObject: X(!0, "Object"),
  };
  if (!t.Component)
  ...
  Object.defineProperty(e, "Observer", {
    ...
    Object.defineProperty(e, "enableStaticRendering", {
      enumerable: !0,
      get: function () {
        return n.enableStaticRendering;
      },
    }),
    Object.defineProperty(e, "isUsingStaticRendering", {
      enumerable: !0,
      get: function () {
        return n.isUsingStaticRendering;
      },
    }),
    Object.defineProperty(e, "observerBatching", {
      enumerable: !0,
      get: function () {
        return n.observerBatching;
      },
    }),
    Object.defineProperty(e, "useAsObservableSource", {
      enumerable: !0,
      get: function () {
        return n.useAsObservableSource;
      },
    }),
    Object.defineProperty(e, "useLocalObservable", {
      enumerable: !0,
      get: function () {
        return n.useLocalObservable;
      },
    }),
    Object.defineProperty(e, "useLocalStore", {
      enumerable: !0,
      get: function () {
        return n.useLocalStore;
      },
    }),
    Object.defineProperty(e, "useObserver", {
      enumerable: !0,
      get: function () {
        return n.useObserver;
      },
    }),
    Object.defineProperty(e, "useStaticRendering", {
      enumerable: !0,
      get: function () {
        return n.useStaticRendering;
      },
    }),
    (e.MobXProviderContext = _),
    (e.PropTypes = W),
    (e.Provider = M),
    (e.disposeOnUnmount = function e(r, t) {
      ...
      var c = !!r[q] || !!r[D];
      return (
        ("string" == typeof t ? r[q] || (r[q] = []) : r[D] || (r[D] = [])).push(
          t
        ),
        c || m(r, "componentWillUnmount", L),
