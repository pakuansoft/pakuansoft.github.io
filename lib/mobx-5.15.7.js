...
(function (global, factory) {
  ...
  var mobxDidRunLazyInitializersSymbol = Symbol(
      ...
      case exports.IDerivationState.POSSIBLY_STALE: {
        ...
        for (var i = 0; i < l; i++) {
          ...
          if (isComputedValue(obj)) {
            ...
            if (
              derivation.dependenciesState === exports.IDerivationState.STALE
            ) {
              untrackedEnd(prevUntracked);
              allowStateReadsEnd(prevAllowStateReads);
              return true;
  ...
  function bindDependencies(derivation) {
    ...
    if (
      lowestNewObservingDerivationState !== exports.IDerivationState.UP_TO_DATE
    ) {
  ...
  function interceptHook(hook, thing, arg2, arg3) {
    var atom =
      typeof arg3 === "function" ? getAtom(thing, arg2) : getAtom(thing);
  ...
  function decorate(thing, decorators) {
    ...
    var _loop_1 = function (prop) {
      ...
      var newDescriptor = propertyDecorators.reduce(function (
        accDescriptor,
        decorator
      ) {
  ...
  var ObservableArrayAdministration = /** @class */ (function () {
    ...
    ObservableArrayAdministration.prototype.notifyArrayChildUpdate = function (
      ...
      if (notifySpy && process.env.NODE_ENV !== "production")
        spyReportStart(
          __assign(__assign({}, change), { name: this.atom.name })
        );
  ...
  var ObservableMap = /** @class */ (function () {
    ...
    ObservableMap.prototype.delete = function (key) {
      ...
      if (this._has(key)) {
        ...
        if (notifySpy && process.env.NODE_ENV !== "production")
          spyReportStart(
            __assign(__assign({}, change), { name: this.name, key: key })
          );
    ...
    ObservableMap.prototype.forEach = function (callback, thisArg) {
      ...
      try {
        for (
          var _c = __values(this), _d = _c.next();
          !_d.done;
          _d = _c.next()
        ) {
  ...
  var isObservableSet = createInstanceofPredicate(
    "ObservableSet",
    ObservableSet
  );
