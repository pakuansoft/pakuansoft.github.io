                ...
                return (
                  ...
                  (i = [
                    ...
                    },
                    {
                      ...
                      value: function (t) {
                        return this.validate(
                          Object.assign(this.getDefaults(), t)
                        );
                      },
                    },
                    {
                    ...
                    },
                    {
                      ...
                      value: function (t) {
                        for (var e in t)
                          this.validators.has(e) &&
                            (t[e] = this.validators.get(e)(t[e]));
                        for (var n in t) {
              ...
              return (
                (e = [
                  ...
                  },
                  {
                    ...
                    value: function (t, e) {
                      Object.prototype.hasOwnProperty.call(this._events, t) ||
                        (this._events[t] = []),
                        this._events[t].indexOf(e) < 0 &&
              ...
              (r = [
                {
                  ...
                  value: function (t) {
                    var e,
                      ...
                      a = t.button;
                    return {
                      axis: this.optionResolver.resolve(
                        null !==
                          (e =
                            null !== (n = null != i ? i : a) && void 0 !== n
                              ? n
                              : t) && void 0 !== e
                          ? e
                          : {}
                      ),
                      button: this.optionResolver.resolve(
                        null !==
                          (r =
                            null !== (o = null != a ? a : i) && void 0 !== o
                              ? o
                              : t) && void 0 !== r
                          ? r
                          : {}
          ...
          return (
            ...
            (n = [
              ...
              },
              {
                ...
                value: function (t, e) {
                  t
                    ? (null === this.handlers[e] && this.registerHandler(e, t),
                      this.handlers[e].update(t))
                    : this.handlers[e] && this.removeGamepad(e);
                },
              },
              {
                key: "registerHandler",
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  this.emit("gamepad:axis", t.detail),
                    ...
                    this.emit(
                      "gamepad:".concat(e, ":axis:").concat(t.detail.axis),
                      t.detail
                    );
                },
              },
              {
                ...
                value: function (t) {
                  ...
                  this.emit("gamepad:button", t.detail),
                    ...
                    this.emit(
                      "gamepad:".concat(e, ":button:").concat(t.detail.button),
                      t.detail
                    );
                },
              },
